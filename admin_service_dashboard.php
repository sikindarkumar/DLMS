...
if($msg=="done"){
    echo "<div class='alert alert-success' role='alert'>Successfully Sent Request</div>";
}
elseif($msg=="fail"){
    echo "<div class='alert alert-danger' role='alert'>Failure Sent Request</div>";
}
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <Button class="greenbtn" >BOOK REQUEST APPROVED</Button>
            ...
            padding: 8px;'>Person Name</th><th>Person Type</th><th>Book Name</th><th>Days </th><th>Approved</th></tr>";
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="csit"/>CS-IT<input type="radio" name="branch" value="Electronics&Communication"/>Electronics & Communication<div style="margin-left:80px"><input type="radio" name="branch" value="civil"/>Civil<input type="radio" name="branch" value="Electrical"/>Electrical<input type="radio" name="branch" value="Mechanical"/>Mechanical<input type="radio" name="branch" value="Others"/>Others</div>
            </div>   
...
?>
            ...
            <p style="color:black"><u>Book Details</u> : &nbsp&nbsp<?php echo $bookdetail ?></p>
            ...
            <p style="color:black"><u>Book issued</u> : &nbsp&nbsp<?php echo $bookrent ?></p>
