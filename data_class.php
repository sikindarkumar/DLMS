...
class data extends db {
    ...
    function addnewuser($name,$pasword,$email,$type){
        ...
        if($this->connection->exec($q)) {
            header("Location:admin_service_dashboard.php?msg=New Add Successful");
        }
    ...
    function addbook($bookpic, $bookname, $bookdetail, $bookauthor, $bookpub, $branch, $bookprice, $bookquantity) 
    {
       ...
       $q="INSERT INTO book (id,bookpic,bookname, bookdetail, bookauthor, bookpub, branch, bookprice,bookquantity,bookava,bookrent)VALUES('','$bookpic', '$bookname', '$bookdetail', '$bookaudor', '$bookpub', '$branch', '$bookprice', '$bookquantity','$bookquantity',0)";
        ...
        if($this->connection->exec($q)) {
            header("Location:admin_service_dashboard.php?msg=Successful");
        }
    ...
    function delteuserdata($id){
        ...
        if($this->connection->exec($q)){
           ...
           header("Location:admin_service_dashboard.php?msg=Successful");  // change
        }
        else{
           header("Location:admin_service_dashboard.php?msg=fail");
        }
